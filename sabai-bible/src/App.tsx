      ...
      <main>
        ...
        >
          ...
          <div className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[300px] rounded-full blur-[120px] opacity-30"
               style={{ background: theme === 'dark' ? 'radial-gradient(ellipse,#ca8a04 0%,transparent 70%)' : 'radial-gradient(ellipse,#fde68a 0%,transparent 70%)' }} />
                ...
                {tabs.map(({ id, label, sub, icon: Icon }) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <div className={`text-xs font-extrabold leading-none ${active ? '' : ''}`}>{label}</div>
